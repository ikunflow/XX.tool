...
PM.register({
    ...
    render: function () {
        return '' +
            ...
            '<div style="position:absolute;top:0;left:0;width:50%;height:100%;overflow:hidden;" id="cmpLeftPane"><img id="cmpLeftImg" style="display:block;max-width:800px;width:100%;" alt="原图"></div>' +
            '<div id="cmpRightPane" style="width:100%;"><img id="cmpRightImg" style="display:block;max-width:800px;width:100%;" alt="压缩后"></div>' +
